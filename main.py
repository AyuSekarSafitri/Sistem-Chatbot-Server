...
#if "tujuan" not in db:
db["tujuan"] = "Tujuan Aspirasi merupakan tujuan/sasaran dari aspirasi kamu disalurkan."
# print(db["tujuan"])

#if "form" not in db:
db["form"] = """Terima kasih sudah mau memberikan aspirasi kepada kami! Kamu bisa memasukkan aspirasi kamu pada link berikut ini :  https://bit.ly/AspirationDay2022."""
# print(db["form"])
...
async def tes(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  ...
  await update.message.reply_text(db["tes"])
...
def main() -> None:
  ...
  application = Application.builder().token(
    "5827585350:AAGNzIkXOE34cVqgtRvRSO1VdJ72oACkGuk").build()
